                    ...
                    <div className={css(styles.bodyLeft)}>
                        ...
                        <div className={css(styles.sectionBody)}>
                            ...
                            <Typography
                                ...
                                style={{ marginTop: '16px' }}
                            >
                                <b>Neural Networks Learning Resource</b>
                            </Typography>
                            <Typography
                                variant='body2'
                                style={{ marginTop: '2px' }}
                            >
                                Compiled notes taken from Russell D. Reed's
                                "Neural Smithing" book with supporting code
                                to test and visualize claims from the book.
                            </Typography>
                        </div>
                        <div className={css(styles.sectionDivider)}/>
                        <div className={css(styles.sectionHeader)}>
