                    ...
                    <div className={css(styles.bodyLeft)}>
                        ...
                        <div className={css(styles.sectionBody)}>
                            ...
                            <Typography
                                ...
                                style={{ marginTop: '2px' }}
                            >
                                Worked in a team of 7 to develop an Agile poker
                                bidding website that assists in hosting remote
                                Scrum meetings.
                                <div style={{ marginTop: '8px' }}/>
                                Utilized Socket.IO to develop backend support for
                                hosting individual rooms that users could connect
                                to and bid tasks in a seamless real-time environment.
                            </Typography>
                        </div>
                        <div className={css(styles.sectionDivider)}/>
                        <div className={css(styles.sectionHeader)}>
